...
func GenerateDescriptorHTML(selfhosted bool) string {
	page := applyLayout(LayoutOptions{
		Title:      "Bitcoin Inheritance - Descriptor Backup",
  ...
  <meta name="generator" content="Bitcoin Inheritance {{VERSION}}">
  ...
  <meta property="og:title" content="Bitcoin Inheritance - Descriptor Backup">
  ...
  <meta name="twitter:title" content="Bitcoin Inheritance - Descriptor Backup">
...
const descriptorFooter = `<p>Bitcoin Inheritance {{VERSION}}</p>
    <p>
